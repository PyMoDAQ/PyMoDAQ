DAQ_Viewer
==========
Module to be used to interface any detector and plot live data and many other features such as data analysis. The default detectors are the mock ones (a kind of software based detector generating data useful to test the program). Other detectors may be loaded as plugins, see section: :ref:`viewer_plugins`.
...
* Ini. Det: Initialize the hardware with the given settings (see :ref:`hardware_settings`.)
