...
of PyMoDAQ, for instance using the :ref:`experiment_manager` for defining Actuators and Detectors in the
...
default *experiment* file to load if executing directly the *DAQ_Scan* extension, default type of *Scan*
