...
from managers.h5manager import H5Manager
...
from pymodaq.utils.managers.h5manager import H5ManagerExt
...
class CustomExt(CustomApp):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super().__init__(parent, h5manager_class=H5ManagerExt, **kwargs)
    ...
    @property
    def h5_manager(self) -> H5ManagerExt:
        return super().h5_manager
