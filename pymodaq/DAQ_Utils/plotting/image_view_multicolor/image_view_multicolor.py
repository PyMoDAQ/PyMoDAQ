...
#import PyMoDAQ
from PyMoDAQ.DAQ_Utils.plotting.image_view_multicolor.image_view_multicolor_GUI import Ui_Form
...
class Image_View_Multicolor(QtWidgets.QWidget):
    ...
    def __init__(self,parent=None,scaling_options=edict(scaled_xaxis=edict(label="",units=None,offset=0,scaling=1),scaled_yaxis=edict(label="",units=None,offset=0,scaling=1))):
        super(Image_View_Multicolor,self).__init__()
        #setting the GUI
        self.ui=Ui_Form()
