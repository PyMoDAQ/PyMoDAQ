...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.settings_widget)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/Labview_icons/Icon_Library/close2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Quit_pb.setIcon(icon8)
