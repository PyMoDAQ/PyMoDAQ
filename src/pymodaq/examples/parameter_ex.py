    ...
    params = [
        ...
        {'title': 'Selectable items:', 'name': 'itemss', 'type': 'group', 'children': [
            ...
            {'title': 'Checkable items', 'name': 'itemsbisbis', 'type': 'itemselect',
             'value': dict(all_items=['item1', 'item2', 'item3'], selected=['item2']),
             'tip': 'If checkbox is True, user can select item by checking/unchecking items', 'show_pb': True,'checkbox':True,},                        
            {'title': 'Dragable items', 'name': 'itemsbisbisbis', 'type': 'itemselect',
             'value': dict(all_items=['item1', 'item2', 'item3'], selected=['item2']),
