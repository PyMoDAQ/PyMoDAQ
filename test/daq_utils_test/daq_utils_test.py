...
class TestScans:
    ...
    def test_ScanParameters(self):
        ...
        axis_2_unique = [],
        positions = []
        scan_param = utils.ScanParameters(Nsteps, axis_1_indexes, axis_2_indexes,
    ...
    def test_set_scan_spiral(self):
        sparam = utils.set_scan_spiral(10.1, -5.87, 0.5, 0.12)
        ...
        sparam = utils.set_scan_spiral(10.1, -5.87, 0., 0.12)
        assert sparam.Nsteps == 1
        sparam = utils.set_scan_spiral(10.1, -5.87, 1., 0.)
        assert sparam.Nsteps == 1

        sparam = utils.set_scan_spiral(10.1, -5.87, 1., 0.01)
        assert sparam.Nsteps == 16384

        sparam = utils.set_scan_spiral(10.1, -5.87, 1., 0.01, 500)
        assert sparam.Nsteps == 512

    def test_set_scan_linear(self):
        sparam = utils.set_scan_linear(0, 0, 1, -2, 0.1, -0.3)
        ...
        sparam = utils.set_scan_linear(0, 0, 1, 2, 0.01, 0.03)
        assert sparam.Nsteps == 6767
        sparam = utils.set_scan_linear(0, 0, 1, 2, 0.01, 0.03, False, 1000)
        assert sparam.Nsteps == 1014
        #  test back and forth
        sparambf = utils.set_scan_linear(0, 0, 1, 2, 0.01, 0.03, True, 1000)
        ...
        sparam = utils.set_scan_linear(0, 0, 1, 2, 0.0, 0.03)
        assert sparam.Nsteps == 1
        sparam = utils.set_scan_linear(0, 0, 1, 2, 0.01, 0.0)
        assert sparam.Nsteps == 1
        sparam = utils.set_scan_linear(0, 0, 1, -2, 0.01, 0.03)
        assert sparam.Nsteps == 1
        sparam = utils.set_scan_linear(0, 0, 0, -2, 0.01, 0.03)
        assert sparam.Nsteps == 1

    def test_set_scan_random(self):
        sparam = utils.set_scan_random(0, 0, 1, -2, 0.1, -0.3)
        assert sparam.Nsteps == 77
